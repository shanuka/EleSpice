package com.elephanti.elephanti;
...
import com.elephanti.elephanti.model.Follower;
import com.elephanti.elephanti.model.FollowerList;
import com.elephanti.elephanti.request.FollowersRequest;
...
public class MainActivity extends Activity {
	...
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
		...
		if (savedInstanceState.containsKey(KEY_LAST_REQUEST_CACHE_KEY)) {
			...
			spiceManager.getFromCache(FollowerList.class, lastRequestCacheKey,
					DurationInMillis.ONE_MINUTE,
					new ListFollowersRequestListener());
		}
	}
	...
	private class ListFollowersRequestListener implements
		...
		public void onRequestSuccess(FollowerList listFollowers) {
			...
			// listFollowers could be null just if
